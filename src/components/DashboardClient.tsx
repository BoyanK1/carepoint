  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-4 py-8 sm:px-6 lg:py-12">
      <header className="space-y-2">
        ...
        <p className="text-sm leading-relaxed text-slate-600 sm:text-base">{welcome}</p>
      </header>
      ...
      <section className="grid gap-6 md:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="mt-2 grid gap-2">
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                ...
                <button
                  ...
                  className="rounded-full bg-slate-900 px-4 py-2.5 text-xs font-semibold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {cityStatus === "saving"
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          ...
          <div className="mt-4 flex flex-col gap-3">
            <Link
              href="/profile"
              className="rounded-full bg-slate-900 px-4 py-2.5 text-center text-sm font-semibold text-white transition hover:bg-slate-800"
            >
